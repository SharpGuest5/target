...
def generate_visualizations(results):
    ...
    if results.get("top_ips") and len(results["top_ips"]) > 0:
        ...
        plt.xlabel('IP Adress', fontsize=14)
        plt.ylabel('Number of activities', fontsize=14)
        plt.title('The most active IP address', fontsize=16, pad=20)
    ...
    if results.get("severity_count") and sum(results["severity_count"].values()) > 0:
        ...
        plt.title('Distribution of threat severity', fontsize=16, pad=20)
    ...
    if results.get("threats") and len(results["threats"]) > 0:
        ...
        plt.title('Time distribution of threat activities', fontsize=16, pad=20)
